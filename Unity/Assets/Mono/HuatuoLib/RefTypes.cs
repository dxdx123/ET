...
public class RefTypes : MonoBehaviour
{
    ...
    List<Type> GetTypes()
    {
        ...
        {
            typeof (DictionaryInterfaceImplementerSerializer<Dictionary<int, long>, int, long>),
            typeof (Queue<ValueTuple<int, long, int>>),
        };
    }
    ...
    void RefContainer()
    {
        new List<object>()
        {
            ...
            new ET.StructBsonSerialize<UnityEngine.Vector3>(),
            new ET.StructBsonSerialize<UnityEngine.Vector4>(),
            new ET.StructBsonSerialize<UnityEngine.Quaternion>(),
            //new ET.MultiMap<long, ET.c>(),
        };
    }
